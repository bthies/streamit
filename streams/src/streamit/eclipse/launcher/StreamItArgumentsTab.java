...
public class StreamItArgumentsTab extends JavaLaunchConfigurationTab {
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy config) {
		// CHANGED kkuo
		config.setAttribute(StreamItLauncherPlugin.ATTR_SECONDARY_CLASSES, (String)null);
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		try {
			// CHANGED kkuo
			fSecondaryClassesText.setText(configuration.getAttribute(StreamItLauncherPlugin.ATTR_SECONDARY_CLASSES, EMPTY_STRING));
	...
	public void performApply(ILaunchConfigurationWorkingCopy configuration) {
		// CHANGED kkuo
		configuration.setAttribute(StreamItLauncherPlugin.ATTR_SECONDARY_CLASSES, getAttributeValueFrom(fSecondaryClassesText));
