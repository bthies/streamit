...
//org.eclipse.jdt.internal.ui.javaeditor.JavaOutlinePage
    ...
    /**
     * Divides the editor's document into ten segments and provides elements
     * for them.
     */
	...
	protected void parse(IDocument document) {
		...
		try {
		    ...
		    fContent.add(new Segment(MessageFormat.format(StreamItEditorMessages.getString("OutlinePage.segment.title_pattern"), new Object[] { new Integer(offset) }), p)); //$NON-NLS-1$
     ...
     * editor.
     */
    public StreamItContentOutlinePage(IDocumentProvider provider, 
				  ITextEditor editor) {
	super();
