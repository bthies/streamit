...
BEGIN_WORK_FUNC
{
  ...
  FFTReorderSimple(  4,  64, b1, get_output());
  advance_input(512);
  advance_output(512);
}
END_WORK_FUNC
...
BEGIN_WORK_FUNC
{
  float b0[512];
  float b1[512];
  FFTReorderSimple(  8,  32, get_input(), b1);
  FFTReorderSimple( 16,  16, b1, b0);
  FFTReorderSimple( 32,   8, b0, get_output());
  advance_input(512);
  advance_output(512);
}
END_WORK_FUNC
...
BEGIN_WORK_FUNC
{
  float b0[512];
  float b1[512];
  FFTReorderSimple( 64,   4, get_input(), b0);
  CombineDFT(128,   2, state.c[0].wn_r, state.c[0].wn_i, b0, b1);
  CombineDFT( 64,   4, state.c[1].wn_r, state.c[1].wn_i, b1, get_output());
  advance_input(512);
  advance_output(512);
}
END_WORK_FUNC
...
BEGIN_WORK_FUNC
{
  // float b0[512];
  float b1[512];
  CombineDFT( 32,   8, state.c[2].wn_r, state.c[2].wn_i, get_input(), b1);
  CombineDFT( 16,  16, state.c[3].wn_r, state.c[3].wn_i, b1, get_output());
  advance_input(512);
  advance_output(512);
}
END_WORK_FUNC
...
BEGIN_WORK_FUNC
{
  // float b0[512];
  float b1[512];
  CombineDFT(  8,  32, state.c[4].wn_r, state.c[4].wn_i, get_input(), b1);
  CombineDFT(  4,  64, state.c[5].wn_r, state.c[5].wn_i, b1, get_output());
  advance_input(512);
  advance_output(512);
}
END_WORK_FUNC
...
BEGIN_WORK_FUNC
{
  // float b0[512];
  float b1[512];
  CombineDFT(  2, 128, state.c[6].wn_r, state.c[6].wn_i, get_input(), b1);
