 ...
 *
 * $Id: JIfStatement.java,v 1.10 2003-08-29 19:25:37 thies Exp $
 */
...
protected void deepCloneInto(at.dms.kjc.JIfStatement other) {
  ...
  other.thenClause = (at.dms.kjc.JStatement)at.dms.kjc.AutoCloner.cloneToplevel(this.thenClause, other);
  other.elseClause = (at.dms.kjc.JStatement)at.dms.kjc.AutoCloner.cloneToplevel(this.elseClause, other);
}
