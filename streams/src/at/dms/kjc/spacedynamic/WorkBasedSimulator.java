...
public class WorkBasedSimulator extends Simulator
{
    ...
    public void simulate() 
    {
        ...
        workEstimatesMap = new WorkEstimatesMap(ssg.getStreamGraph(), ssg.getTopLevel());
    ...
    */
    ...
    {
        Iterator upstream = Util.getAssignedEdges(layout, identity).iterator();
                                    ...
                                    HashSet visited) 
    {
        ...
        Iterator downstream = Util.getAssignedEdges(layout, node).iterator();
