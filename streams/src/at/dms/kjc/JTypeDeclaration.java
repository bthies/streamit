 ...
 *
 * $Id: JTypeDeclaration.java,v 1.7 2003-08-21 09:44:21 thies Exp $
 */
...
protected void deepCloneInto(at.dms.kjc.JTypeDeclaration other) {
  ...
  other.body = (at.dms.kjc.JPhylum[])at.dms.kjc.AutoCloner.cloneToplevel(this.body, this);
  ...
  other.inners = (at.dms.kjc.JTypeDeclaration[])at.dms.kjc.AutoCloner.cloneToplevel(this.inners, this);
  other.interfaces = (at.dms.kjc.CClassType[])at.dms.kjc.AutoCloner.cloneToplevel(this.interfaces, this);
  other.outerThis = (at.dms.kjc.JFieldDeclaration)at.dms.kjc.AutoCloner.cloneToplevel(this.outerThis, this);
  other.defaultConstructor = (at.dms.kjc.JConstructorDeclaration)at.dms.kjc.AutoCloner.cloneToplevel(this.defaultConstructor, this);
  other.statInit = (at.dms.kjc.JInitializerDeclaration)at.dms.kjc.AutoCloner.cloneToplevel(this.statInit, this);
  other.instanceInit = (at.dms.kjc.JInitializerDeclaration)at.dms.kjc.AutoCloner.cloneToplevel(this.instanceInit, this);
