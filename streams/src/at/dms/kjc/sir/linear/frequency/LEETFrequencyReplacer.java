 ...
 * 
 * $Id: LEETFrequencyReplacer.java,v 1.1 2003-01-30 21:05:26 aalamb Exp $
 **/
public class LEETFrequencyReplacer extends FrequencyReplacer{
	...
	JFieldDeclaration[] newFields = makeFieldDeclarations(self.getFields(),realWeightField,
							      imagWeightField, partialField);
	...
	for (int i=0; i<filterSize; i++) {
	    LinearPrinter.println("-->H[" + i + "]=(" +
				  frequency_response_r[i] + "+" +
				  frequency_response_i[i] + "i)");
	}
