...
public class StreamItArgumentsTab extends JavaLaunchConfigurationTab {
	...
	public void createControl(Composite parent) {
		...
		fSecondaryClassesLabel.setText(LaunchingMessages.getString(IStreamItLaunchingConstants.STREAMIT_ARGUMENTS_TAB_SECONDARY)); //$NON-NLS-1$
		...
		fPrgmArgumentsLabel.setText(LauncherMessages.getString(IStreamItLaunchingConstants.JAVA_ARGUMENTS_TAB_PROGRAM)); //$NON-NLS-1$
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy config) {
		...
		config.setAttribute(IJavaLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS, IStreamItLaunchingConstants.DEFAULT_ITERATIONS);
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		try {
			// CHANGED kkuo
			fSecondaryClassesText.setText(configuration.getAttribute(IStreamItLaunchingConstants.ATTR_SECONDARY_CLASSES, IStreamItLaunchingConstants.EMPTY_STRING));
			fPrgmArgumentsText.setText(configuration.getAttribute(IJavaLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS, IStreamItLaunchingConstants.DEFAULT_ITERATIONS)); //$NON-NLS-1$
		
			fVMArgumentsBlock.initializeFrom(configuration);
			fWorkingDirectoryBlock.initializeFrom(configuration);
		} catch (CoreException e) {
			setErrorMessage(LauncherMessages.getString(IStreamItLaunchingConstants.JAVA_ARGUMENTS_TAB_EXCEPTION) + e.getStatus().getMessage()); //$NON-NLS-1$
	...
	public String getName() {
		return LauncherMessages.getString(IStreamItLaunchingConstants.JAVA_ARGUMENTS_TAB_ARGUMENTS);
	}	
