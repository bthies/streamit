 ...
 *
 * $Id: CTryFinallyContext.java,v 1.5 2003-08-29 19:25:36 thies Exp $
 */
...
protected void deepCloneInto(at.dms.kjc.CTryFinallyContext other) {
  ...
  other.breaks = (java.util.Vector)at.dms.kjc.AutoCloner.cloneToplevel(this.breaks, other);
  other.continues = (java.util.Vector)at.dms.kjc.AutoCloner.cloneToplevel(this.continues, other);
}
