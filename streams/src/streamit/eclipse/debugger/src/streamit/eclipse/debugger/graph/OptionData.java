...
public class OptionData {
	...
	private Set fExpandedStream; // set of String streamNameWithRuntimeId
	...
	public OptionData(boolean highlighting, LaunchData data) {
		fLaunchData = data;
	...
	public boolean hasFilterInstanceBreakpoint(String filterName, String filterRuntimeId, String filterStaticId) {
		return fLaunchData.hasFilterInstanceBreakpoint(filterName, filterRuntimeId, filterStaticId);
	}
}