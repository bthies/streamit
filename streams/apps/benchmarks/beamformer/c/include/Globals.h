...
static const unsigned long    		FINE_FILTER_SIZE = 4;	        /*  # of taps in fine filter */
static const unsigned long 		NUM_CHANNELS = 2;	        /*  # of input rows */
static const unsigned long		NUM_RANGES = 64;	        /*  # of output rows */
static const unsigned long    		NUM_BEAMS = 2;			/*  # of beams for beam forming step */
static const unsigned long 		COARSE_DECIMATION_RATIO = 1;	/*  Decimation ratio after coarse filter */
static const float			FFT_SCALE = 1.0;		/*  Scale factor for forward fft */
static const float			NOISE_LEVEL = 1.0;		/*  Noise level */
static const unsigned long 	       	FINE_DECIMATION_RATIO = 1;	/*  Decimation ratio after fine filter */
