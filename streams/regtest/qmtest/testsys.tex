...
\item {\tt output_type} Type of output.  Legitimate values are {\tt ASCII}, {\tt int}, and {\tt float} where {\tt int}, and {\tt float} refer to 32-bit integers and 32-bit floats, and ASCII is a series of lines with one formatted integer or floating point value per line. 
