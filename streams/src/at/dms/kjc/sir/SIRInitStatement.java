...
protected void deepCloneInto(at.dms.kjc.sir.SIRInitStatement other) {
  ...
  other.args = (java.util.List)at.dms.kjc.AutoCloner.cloneToplevel(this.args, this);
  other.target = (at.dms.kjc.sir.SIRStream)at.dms.kjc.AutoCloner.cloneToplevel(this.target, this);
}
