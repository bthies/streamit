 ...
 * </p>
 */
public class StreamItSourceViewerConfiguration extends SourceViewerConfiguration {
	 ...
	 */
	public StreamItSourceViewerConfiguration(ITextEditor editor) {
		// CHANGED by kkuo
	...
	protected RuleBasedScanner getCodeScanner() {
		// TO DO
		// CHANGED by kkuo
		return new StreamItCodeScanner(getColorManager(), getPreferenceStore());
	}
