 ...
 */
class CountStatements extends FilterWorkVisitor {
...
/**
 * Do something on all filter work functions of a given stream.
 */
abstract class FilterWorkVisitor extends SLIREmptyVisitor {
    /**
