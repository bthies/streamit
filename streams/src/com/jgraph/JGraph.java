...
import com.jgraph.graph.DefaultGraphSelectionModel;
import com.jgraph.graph.DefaultPort;
import com.jgraph.graph.Edge;
import com.jgraph.graph.EdgeView;
import com.jgraph.graph.EllipseCell;
import com.jgraph.graph.EllipseView;
...
extends com.jgraph.plaf.basic.TransferHandler.JAdapterComponent // JAVA13: com.jgraph.plaf.basic.TransferHandler
implements CellViewFactory, Scrollable, Accessible, Serializable {

	public static final String VERSION = "JGraph Geneva (v2.2)";
	...
	public void updateUI() {
		setUI(new com.jgraph.plaf.basic.BasicGraphUI());
		invalidate();
	}
	...
	* 		GraphCell subclasses (Port, Edge)
	...
	protected VertexView createVertexView(Object v, CellMapper cm) {
		...
		// Else create new Rectangular vertex
