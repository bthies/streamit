...
public class StreamItEditorPreferencePage extends PreferencePage 
    ...
    protected IPreferenceStore doGetPreferenceStore() {
		return StreamItEditorPlugin.getDefault().getPreferenceStore();
    }
    ...
    protected void performDefaults() {
		...
		StreamItEditorPlugin.getDefault().initializeDefaultPreferences(getPreferenceStore());
		initializeDefaults();
    }
    ...
    public boolean performOk() {    	
		storeValues();
		StreamItEditorPlugin.getDefault().savePluginPreferences();
		return true;
    }
