...
over a time period of 40 seconds. Every 40 seconds the CCP computes
...
different machine in the new mapping is more than 4 percent, the
...
We use a MPEG-2 Decoder implementation in StreamIt for our load 
...
our dynamic load balancing algorithm with two different thresholds of 4~percent 
and 8~percent for reconfiguration. The different thresholds represent 
different sensitivity. With the 4~percent threshold the frequency 
...
with both thresholds and performs better than with the assumption that 
all machines have equal CPU resources. 
