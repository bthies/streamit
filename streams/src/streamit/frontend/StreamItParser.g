 ...
 * $Id: StreamItParser.g,v 1.7 2002-08-12 19:00:59 dmaze Exp $
 */
...
stream_or_inline
	...
	| data_type func_call_params SEMI!
	;
...
incOrDec
	:	left_expr (INCREMENT^ | DECREMENT^)
	|	(INCREMENT | DECREMENT) left_expr 
		{ System.err.println ("pre-increment/decrement is not supported"); }
	;
