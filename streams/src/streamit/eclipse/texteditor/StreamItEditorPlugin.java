 ...
 */
public class StreamItEditorPlugin extends AbstractUIPlugin {

    // Default instance of the receiver
    private static StreamItEditorPlugin inst;
     ...
     */
    public StreamItEditorPlugin(IPluginDescriptor descriptor) {
		super(descriptor);
     ...
     *
     * @return the default StreamItEditorPlugin instance
     */
    static public StreamItEditorPlugin getDefault() {
		return inst;
    }
