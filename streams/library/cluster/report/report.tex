...
performance of the MPEG2 decoder on a non-homegeneous 2~machine and
...
\subfigure[On a heterogenous cluster (840MHz, 1GHz, 2.2GHz, 3.6GHz) with an interruption after frame 8]{
  \includegraphics*[width=230pt]{fig5.png}
}
\end{figure}
...
statistics to dynamically adjust load balancing for a non-homogeneous
