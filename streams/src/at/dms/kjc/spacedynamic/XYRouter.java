...
public class XYRouter 
{
    ...
    public static LinkedList getRoute(StaticStreamGraph ssg, ComputeNode src, ComputeNode dst) 
    {
    ...
    public static int distance(StaticStreamGraph ssg, ComputeNode src, ComputeNode dst) 
