 ...
 *
 * $Id: JCompilationUnit.java,v 1.7 2003-08-29 19:25:36 thies Exp $
 */
...
protected void deepCloneInto(at.dms.kjc.JCompilationUnit other) {
  ...
  other.packageName = (at.dms.kjc.JPackageName)at.dms.kjc.AutoCloner.cloneToplevel(this.packageName, other);
  ...
  other.typeDeclarations = (at.dms.kjc.JTypeDeclaration[])at.dms.kjc.AutoCloner.cloneToplevel(this.typeDeclarations, other);
  other.allLoadedClasses = (java.util.Hashtable)at.dms.kjc.AutoCloner.cloneToplevel(this.allLoadedClasses, other);
  other.export = (at.dms.kjc.CCompilationUnit)at.dms.kjc.AutoCloner.cloneToplevel(this.export, other);
}
